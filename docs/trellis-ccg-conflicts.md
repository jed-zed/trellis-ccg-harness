...
| Claude product-manager boundary versus workspace ownership | Blocking | Claude may review product evidence, but must never inherit workspace or lifecycle authority | Fixed: Codex is the sole writer; Claude is allowed only through the selected read-only product-manager contract |
