...
const LEGACY_CONFIGS: WorkflowConfig[] = [
  ...
  cmd('frontend', 2, 'development', '前端专项', 'Frontend Tasks', '使用 frontend 职责当前 Provider', 'Uses the current frontend role provider'),
  ...
  cmd('backend', 3, 'development', '后端专项', 'Backend Tasks', '使用 backend 职责当前 Provider', 'Uses the current backend role provider'),
