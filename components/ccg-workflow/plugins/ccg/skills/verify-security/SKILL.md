...
`node ~/.claude/.ccg/engine/tools/grok-intelligence/route.mjs --workflow verify-security --phase quality-verify --task-file ".ccg/tasks/<task-id>/intelligence-request.md" --state-file ".ccg/tasks/<task-id>/intelligence-route.json"`
