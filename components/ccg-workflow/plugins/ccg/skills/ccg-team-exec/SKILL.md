...
`node ~/.claude/.ccg/engine/tools/grok-intelligence/route.mjs --workflow team-exec --phase team-intake --task-file ".ccg/tasks/<task-id>/intelligence-request.md" --state-file ".ccg/tasks/<task-id>/intelligence-route.json"`
