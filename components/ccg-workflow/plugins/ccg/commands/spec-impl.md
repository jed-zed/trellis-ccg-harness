...
`node ~/.claude/.ccg/engine/tools/grok-intelligence/route.mjs --workflow spec-impl --phase spec-plan --task-file ".ccg/tasks/<task-id>/intelligence-request.md" --state-file ".ccg/tasks/<task-id>/intelligence-route.json"`
